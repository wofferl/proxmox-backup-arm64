...
if [ "${PBSVERSION}" = "pbs3" ]; then
	PROXMOX_BACKUP_VER="3.0.5-1"
	PROXMOX_BACKUP_GIT="7d1085735bbb619f7ba95467406119bdd2ba172d"
	PROXMOX_GIT="a815fc4f5644e533b5376dc6227f443b18beb612"
...
if [ "${PBSVERSION}" = "pbs2" ]; then
	...
	PVE_XTERMJS_VER="5.3.0-2"
	PVE_XTERMJS_GIT="e2e62fc67368ad25a35c6d009f9d85ac5ef97233"
